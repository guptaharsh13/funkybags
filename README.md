In this E-Commerce project, I have made use of Celery to optimized the way in which we usually send emails using Django. Once a user signs in to the website, and clicks on the BUY NOW button -
